...
- You may **not** offer Fujin (or a derivative whose value derives
  substantially from Fujin) as a paid product or paid hosted/managed
  service to third parties without a commercial licence from the
  Licensor.
- Bundling Fujin into a larger product whose paid value clearly
  derives from other components is permitted, as long as the Fujin
  portion itself is not the substantial source of paid value.

If you want to sell Fujin as a service or product, contact the
